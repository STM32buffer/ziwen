...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_status = 0;
		ANO_DT_Send_Status(roll,pitch,0,(45),0,0);	
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser2 = 0;
		ANO_DT_Send_Senser2(45,45);//原始数据
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////	
	else if(f.send_motopwm)
	{
		...
		ANO_DT_Send_MotoPWM(dir_pwm_pitch,dir_pwm_yaw,D_yaw_control,D_pitch_control,0,0,0,0);
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid1 = 0;
		ANO_DT_Send_PID(1,ctrl_Roll.Kp  ,ctrl_Roll.Ki  ,ctrl_Roll.Kd,
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid2 = 0;
		ANO_DT_Send_PID(2,ctr2_Roll.Kp  ,ctr2_Roll.Ki  ,ctr2_Roll.Kd,

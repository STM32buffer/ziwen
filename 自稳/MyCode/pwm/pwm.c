...
void TIM4_PWM_Init(u16 arr, u16 psc)
{
	...
	GPIO_InitStructure.GPIO_Pin =  GPIO_Pin_8|GPIO_Pin_7 | GPIO_Pin_9; //TIM_CH1   GPIO_Pin_7 | GPIO_Pin_9 |
	...
	TIM_OC2PreloadConfig(TIM4, TIM_OCPreload_Enable);  //CH3预装载使能	
...
void TIM3_PWM_Init(u16 arr, u16 psc)
{
	...
	GPIO_InitStructure.GPIO_Pin =  GPIO_Pin_1| GPIO_Pin_0; //TIM_CH1| GPIO_Pin_7| GPIO_Pin_1GPIO_Pin_6 |
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;  //复用推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOB, &GPIO_InitStructure);
